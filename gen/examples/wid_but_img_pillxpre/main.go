...
func NewGame() *Game {
	...
	button := widget.NewButton(
		...
		widget.ButtonOpts.Image(&widget.ButtonImage{
			Idle:    DefaultPill(assets.ColorD),
			Hover:   DefaultPill(Mix(assets.ColorD, assets.ColorG, 0.4)),
			Pressed: PressedPill(Mix(assets.ColorD, assets.ColorN, 0.4)),
		}),
		// SKIP-START this
