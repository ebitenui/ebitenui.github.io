...
func NewGame() *Game {
	...
	button := widget.NewButton(
		...
		widget.ButtonOpts.Image(&widget.ButtonImage{
			...
			Hover:        DefaultNineSlice(assets.ColorD),
			Disabled:     DefaultNineSlice(assets.ColorD),
			Pressed:      DefaultNineSlice(assets.ColorD),
			PressedHover: DefaultNineSlice(assets.ColorD),
		}),
		// SKIP-END this
		widget.ButtonOpts.TextColor(&widget.ButtonTextColor{
			Idle:    assets.ColorY,
			Hover:   assets.ColorR,
			Pressed: assets.ColorB,
		}),
		// SKIP-START this
	...
	// END this
	button.GetWidget().CursorEnterEvent.Fire(&widget.WidgetCursorEnterEventArgs{})
	button.GetWidget().MouseButtonPressedEvent.Fire(&widget.WidgetMouseButtonPressedEventArgs{})
